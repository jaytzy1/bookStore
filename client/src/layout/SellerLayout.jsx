    ...
    <div className="bg-white shadow col-md-2 col-sm-2 d-flex flex-column min-vh-100 "  style={{ position: "sticky", top: "0", zIndex: "1020" }}> 
      ...
      <ul className="nav flex-column">
        <li className="nav-item">
          <Link to='/SellerProduct' className="nav-link text-dark">
            <i className="bi bi-house-check-fill me-1"></i> Dashboard
          </Link>
        </li>
        <li className="nav-item">
          <Link to='/AddProduct' className="nav-link text-dark">
            <i className="bi bi-tag-fill me-1"></i> Products
          </Link>
        </li>
       
        <li className="nav-item">
          <Link to='/AllProductSeller' className="nav-link text-dark">
            <i className="bi bi-people-fill me-1"></i> All Products
          </Link>
        </li>
      </ul>
      <div className="" style={{marginTop:'250px'}}>
        <ul className="nav flex-column">
          <li className="nav-item">
            <Link to='/SellerSettings' className="nav-link text-dark">
              <i className="bi bi-gear-fill"></i> Settings
            </Link>
          </li>
          <li className="nav-item">
            <Link to='/SellerHelpCenter' className="nav-link text-dark">
  ...
  <div className="modal" id="signOut">
    <div className="modal-dialog">
      ...
      <div class="modal-footer">
        ...
        <Link to='/SellerSignIn' onClick={HandleSignOutSubmit} className="btn btn-danger">Sign Out</Link>
      </div>
      </div>
    </div>
  </div>
...
<li className="nav-item">
<Link className="nav-link text-dark">
  <i className="bi bi-cash-coin me-1"></i> Transactions
</Link>
</li>
*/